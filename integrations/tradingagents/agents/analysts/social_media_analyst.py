...
from integrations.tradingagents.agents.analysts.sentiment_analyst import (  # noqa: F401
...
_warnings.warn(
    ...
    "Import from integrations.tradingagents.agents.analysts.sentiment_analyst instead.",
    DeprecationWarning,
    stacklevel=2,
)

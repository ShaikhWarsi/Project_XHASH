...
const DEFAULT_INDICATORS: Record<string, IndicatorDef> = {
  ...
  mfi: { name: 'MFI', params: { length: 14 }, category: 'momentum' },
  ...
  pivots: { name: 'Pivots', params: { length: 14 }, category: 'volatility' },
  ...
  twap: { name: 'TWAP', params: {}, category: 'overlap' },
  srlines: { name: 'S/R Lines', params: { window: 200 }, category: 'custom' },
  elliottWave: { name: 'Elliott Wave', params: {}, category: 'volatility' },
  vsa: { name: 'VSA', params: {}, category: 'volume' },
  wyckoff: { name: 'Wyckoff', params: {}, category: 'volume' },
  squeeze: { name: 'Squeeze', params: { length: 20 }, category: 'volatility' },
  rangeFilter: { name: 'Range Filter', params: { length: 14 }, category: 'overlap' },
  volumeOsc: { name: 'Volume Osc', params: { fast: 5, slow: 13 }, category: 'volume' },
  priceOsc: { name: 'Price Osc', params: { fast: 12, slow: 26 }, category: 'momentum' },
  adOsc: { name: 'A/D Osc', params: { length: 14 }, category: 'volume' },
  wilders: { name: "Wilder's Smooth", params: { length: 14 }, category: 'overlap' },
}

...
export default function RLTrainer() {
  ...
  return (
    <div className="space-y-6">
      ...
      {deployMsg && (
        <div style={{ background: 'color-mix(in srgb, var(--accent-green) 4%, transparent)', border: '1px solid color-mix(in srgb, var(--accent-green) 18.8%, transparent)', borderRadius: 'var(--radius-md)', padding: '12px 16px', 
fontSize: 'var(--text-sm)', color: 'var(--accent-green)' }}>
          {deployMsg}
        </div>
      )}
